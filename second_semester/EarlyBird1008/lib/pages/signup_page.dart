...
import 'package:EarlyBird/pages/settings_page.dart'; // (showGlassDialog 때문에 필요, 실제 사용 X)
import '../wallpaper_provider.dart'; // 2. WallpaperProvider import

final FirebaseAuth auth = FirebaseAuth.instance;
final databaseRef = FirebaseDatabase.instance.ref();

// showGlassDialog는 다른 파일에서 가져와야 하지만, 편의상 여기에 포함시킵니다.
// 실제 프로젝트에서는 별도의 유틸 파일로 분리하는 것이 좋습니다.
