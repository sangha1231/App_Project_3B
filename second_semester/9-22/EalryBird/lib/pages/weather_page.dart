...
import 'package:provider/provider.dart'; // 1. Provider package import
...
class _WeatherPageState extends State<WeatherPage> {
  ...
  Widget build(BuildContext context) {
    // 3. Get the WallpaperProvider instance
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 4. Use the dynamic background from the provider
          Positioned.fill(
            child: Image.asset(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            const Icon(Icons.beach_access, size: 20, color: Colors.lightBlueAccent),
