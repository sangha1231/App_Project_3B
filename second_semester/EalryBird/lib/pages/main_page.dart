...
class _MainPageState extends State<MainPage> {
  String _currentWallpaper = 'assets/images/wallpaper_1.jpg';
  ...
  Future<void> _loadWallpaper() async {
    ...
    setState(() {
      _currentWallpaper = prefs.getString('wallpaper') ?? 'assets/images/wallpaper_1.jpg';
    });
  }

  Future<void> _changeWallpaper(String newWallpaper) async {
    final prefs = await SharedPreferences.getInstance();
                    ...
                    Wrap(
                      ...
                      children: [
                        _WallpaperOption(
                          ...
                          onTap: () => _changeWallpaper('assets/images/wallpaper_1.jpg'),
                        ),
                        _WallpaperOption(
                          imagePath: 'assets/images/wallpaper_2.jpg',
                          onTap: () => _changeWallpaper('assets/images/wallpaper_2.jpg'),
                        ),
                        _WallpaperOption(
                          imagePath: 'assets/images/wallpaper_3.jpg',
                          onTap: () => _changeWallpaper('assets/images/wallpaper_3.jpg'),
                        ),
                        _WallpaperOption(
                          imagePath: 'assets/images/wallpaper_4.jpg',
                          onTap: () => _changeWallpaper('assets/images/wallpaper_4.jpg'),
                        ),
                      ],
                    ),
                    const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(_currentWallpaper, fit: BoxFit.cover),
          ),
          SafeArea(
            child: Center(
