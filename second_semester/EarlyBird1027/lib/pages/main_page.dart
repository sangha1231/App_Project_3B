...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // 🚩 3. Firebase 로그인 상태에 따라 사용자 아이디 결정
    final user = _auth.currentUser;
    final displayName = user?.email != null
        ? user!.email!.split('@')[0] // 이메일의 @ 앞부분만 사용
        : 'GUEST'; // 로그인하지 않은 경우
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              UserAccountsDrawerHeader(
                ...
                accountName: Text(
                  // 3단계에서 결정된 아이디 사용
                  user != null ? '$displayName님' : displayName,
                ...
                accountEmail: Text(
                  user?.email ?? '로그인이 필요합니다', // 이메일 또는 안내 메시지 표시
                  style: TextStyle(
                ...
                currentAccountPicture: CircleAvatar(
                  ...
                  backgroundColor: user != null ? Colors.blueAccent : Colors.black,
                  child: Icon(
