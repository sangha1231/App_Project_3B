...
final List<Station> stations = [
  Station('중구', 37.5642135, 126.997655), // 서울 (중구)
  Station('수원시', 37.2635732, 127.0286017), // 경기 (수원)
  Station('춘천시', 37.8813158, 127.7299707), // 강원 (춘천)
  Station('청주시', 36.6424345, 127.4890312), // 충북 (청주)
  Station('홍성군', 36.6014959, 126.6600033), // 충남 (홍성)
  Station('전주시', 35.8213411, 127.1480425), // 전북 (전주)
  Station('목포시', 34.8118351, 126.3921662), // 전남 (목포)
  Station('안동시', 36.5683541, 128.7293574), // 경북 (안동)
  Station('창원시', 35.2279187, 128.681055), // 경남 (창원)
  Station('제주시', 33.4996213, 126.5311884), // 제주 (제주)
];
class DustService {
  final String apiKey;
