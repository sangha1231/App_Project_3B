                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          // 오른쪽 장바구니 아이콘 (필요시 추가)
                          // IconButton(
                          //   icon: const Icon(Icons.shopping_cart_outlined, size: 32, color: Colors.white),
                          //   onPressed: () { },
                          // ),
                        ],
                      ),
                      ...
                      // ─────────────────────────────────────────────────────────────────
                      // 메뉴 리스트 (글래스 패널) — 내부에 스크롤 기능 추가
                      // ─────────────────────────────────────────────────────────────────
                      _GlassPanel(
                        width: double.infinity,
                        // 항목 높이 60 + Divider 높이 2, 총 7개의 항목이므로 높이 계산
                        height: (7 * 60) + (6 * 2) + 32,
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
