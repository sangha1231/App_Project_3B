...
class _WeatherPageState extends State<WeatherPage> {
  ...
  void initState() {
    ...
    controller = WeatherController(
      ...
      MidForecastService("Ss1oqrxEJeZWB2n737U08XyxvdG6k2Uy5nNEwvX0LpBNyTrtrZEK2iDGCCioQXriqSaZIzoZv1HlnLxbIIO4Hw=="),
    );
    fetch();
  }
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text('$dustStatus (${weather!.pm25}㎍/㎥)',
                                          style: TextStyle(fontSize: 14, color: dustColor)),
                                    ],
                                  ),
                                ],
                              ),
